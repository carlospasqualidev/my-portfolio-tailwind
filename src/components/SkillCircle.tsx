...
export const SkillCircle = ({
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center cursor-pointer justify-center  opacity-0 absolute bg-black rounded-full z-50  h-[68px] w-[68px] transition-all duration-200 ease-in hover:opacity-80  ">
        <p>{skillAvg}</p>
      </div>
